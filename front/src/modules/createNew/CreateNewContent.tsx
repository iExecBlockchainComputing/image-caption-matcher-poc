        ...
        >
          <label className="flex w-full max-w-[550px] items-center justify-center hover:cursor-pointer">
            ...
            <div
              ref={dropZone}
              className={clsx(
                dragActive && 'ring-primary ring',
                'border-grey-700 bg-grey-800 relative flex min-h-[300px] flex-1 flex-col items-center justify-center rounded-3xl border text-xl text-white'
              )}
            ...
            >
              ...
              {!fileName && (
                <>
                  ...
                  <span className="text-grey-500 pointer-events-none mt-3 text-xs">
