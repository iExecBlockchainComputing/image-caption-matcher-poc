...
export function CollectionInfoBlock({
  ...
  return (
    <>
      <div className="ld:gap-6 border-grey-700 grid gap-x-2 gap-y-6 rounded-2xl border p-6 text-white md:flex md:justify-evenly">
        ...
        <div className="relative md:ml-4">
          <div className="bg-grey-700 absolute top-1/2 h-px w-full md:left-1/2 md:top-0 md:h-full md:w-px">
            &nbsp;
          </div>
        </div>
        ...
        <div className="grid w-full grid-cols-2 justify-evenly gap-2 lg:flex">
          ...
          <div className="flex flex-1 flex-col items-center">
            ...
            <span className="text-grey-400 text-center text-xs">
          ...
          {!isActiveSubscriptionsLoading && (
            <>
              {hasActiveSubscription && (
                <div className="rounded-30 bg-grey-800 flex items-center justify-center px-6 py-2.5 font-semibold">
                  Subscribed
                ...
                <TooltipProvider delayDuration={0}>
                  <Tooltip>
                    <TooltipTrigger className="flex flex-1 flex-col items-center">
                      <span className="rounded-30 bg-primary text-primary-foreground ring-offset-background dark:hover:bg-grey-100 inline-flex h-11 w-full items-center justify-center px-6 py-3 text-sm font-medium opacity-50 transition-colors duration-300 ease-out">
                        Subscribe
                      </span>
                    </TooltipTrigger>
                    <TooltipContent>
      ...
      <DocLink className="bg-grey-700 mt-3 rounded px-4 py-3 font-normal tracking-tight">
        <div>
